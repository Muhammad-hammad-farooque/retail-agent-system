...
- SHORT DELIVERY NOTIFICATION: If receive_purchase_order response contains "Should I send a short delivery notification", ask the manager yes/no. When manager replies "yes", "yes please", "send it", "notify", or any affirmative — IMMEDIATELY call notify_supplier_short_delivery using the product_id, po_number, quantity_ordered (from po.quantity), and quantity_received from the PREVIOUS receive_purchase_order call. Do NOT ask for clarification — you already have all the details. If manager says "no", "don't send", or "skip" — acknowledge and close.
